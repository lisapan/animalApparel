  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Field name="billingState" component={renderSelect} label="State*" validate={[required]} />
      ...
      <div className="checkoutFormField">
        <button type="button" className="previous" onClick={previousPage}>Edit Shipping Address</button>
        <button type="submit" disable={invalid} className="next">Add Payment Info</button>
      </div>
      </form>
    </div>
  )
