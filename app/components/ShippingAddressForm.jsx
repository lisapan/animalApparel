  ...
  return (
    <div className="checkoutForm">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Field name="shippingState" component={renderSelect} label="State*" validate={[required]} className="checkoutFormField"/>
      ...
      <div className="checkoutFormField">
        <button type="submit" disable={invalid} className="next">Add Billing Info</button>
      </div>
      </form>
    </div>
  )
